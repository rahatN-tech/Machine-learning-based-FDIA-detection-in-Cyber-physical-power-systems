...
meas_with_base_attk = pd.read_csv('./meas_data_base_attk_11bus.csv').drop('Unnamed: 0', axis ="columns")
...
scaler = joblib.load('scaler_neural.pkl')
...
model_path = './regression_neural.h5'
...
file_path = "mse_11_bus_b_attk_std_scaler_neural.pkl"
...
# print(meas_opt_attk_fr_ml.head())


# print(meas_with_optmz_attk)
# meas_for_ml_opt = meas_with_optmz_attk[col_attk]
# meas_fr_ml_base_attk = meas_with_base_attk
# print(meas_for_ml_opt)

# scaler = MinMaxScaler(feature_range=(-1, 1))
# x_verify = scaler.fit_transform(pq_inj_verify)
# xgb_model =joblib.load(model_path)

# y_pred = xgb_model.predict(x_verify)
